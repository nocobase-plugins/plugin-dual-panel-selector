      ...
      const initialValues = {
        ...
        dataConfig: {
          commonFilter: {
            ...
            field: fieldSchema?.['x-component-props']?.dataConfig?.commonFilter?.field || '',
          ...
          leftPanel: {
            ...
            parentField: fieldSchema?.['x-component-props']?.dataConfig?.leftPanel?.parentField || '',
            parentIdField: fieldSchema?.['x-component-props']?.dataConfig?.leftPanel?.parentIdField || '',
          ...
          filter: {
            ...
            customFilterParentField: fieldSchema?.['x-component-props']?.dataConfig?.filter?.customFilterParentField || '',
          }
        }
      };
